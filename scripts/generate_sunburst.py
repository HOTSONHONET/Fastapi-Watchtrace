...
from watchtower.sunburst import render_sunburst_html
...
output_file = latest / "sunburst.html"
render_sunburst_html(tree, str(output_file))

print(f"Sunburst written to: {output_file}")